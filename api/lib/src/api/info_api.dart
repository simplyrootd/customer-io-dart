...
import 'package:customer_io_gen/src/model/inline_response20034.dart';
...
class InfoApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [InlineResponse20034] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse20034>> getCioAllowlist({ 
    ...
    final _path = r'/v1/info/ip_addresses';
    ...
    InlineResponse20034 _responseData;

    try {
      const _responseType = FullType(InlineResponse20034);
