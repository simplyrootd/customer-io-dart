...
import 'package:customer_io_gen/src/model/inline_response20059.dart';

class TrackRegionApi {

  final Dio _dio;

  final Serializers _serializers;

  const TrackRegionApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [InlineResponse20059] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse20059>> getRegion({ 
    ...
    final _path = r'/api/v1/accounts/region';
    ...
    InlineResponse20059 _responseData;

    try {
      const _responseType = FullType(InlineResponse20059);
    ...
    return Response<InlineResponse20059>(
      data: _responseData,
