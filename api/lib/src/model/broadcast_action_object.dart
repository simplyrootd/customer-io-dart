...
part 'broadcast_action_object.g.dart';
...
abstract class BroadcastActionObject implements Built<BroadcastActionObject, BroadcastActionObjectBuilder> {
    ...
    BroadcastActionObjectTypeEnum? get type;
    ...
    BroadcastActionObject._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(BroadcastActionObjectBuilder b) => b;

    factory BroadcastActionObject([void updates(BroadcastActionObjectBuilder b)]) = _$BroadcastActionObject;

    @BuiltValueSerializer(custom: true)
    static Serializer<BroadcastActionObject> get serializer => _$BroadcastActionObjectSerializer();
}

class _$BroadcastActionObjectSerializer implements StructuredSerializer<BroadcastActionObject> {
    @override
    final Iterable<Type> types = const [BroadcastActionObject, _$BroadcastActionObject];

    @override
    final String wireName = r'BroadcastActionObject';

    @override
    Iterable<Object?> serialize(Serializers serializers, BroadcastActionObject object,
        ...
        if (object.type != null) {
            result
                ...
                ..add(serializers.serialize(object.type,
                    specifiedType: const FullType(BroadcastActionObjectTypeEnum)));
        }
        if (object.sendingState != null) {
            result
                ..add(r'sending_state')
                ..add(serializers.serialize(object.sendingState,
                    specifiedType: const FullType(BroadcastActionObjectSendingStateEnum)));
        }
        if (object.from != null) {
            result
                ..add(r'from')
        ...
        if (object.preprocessor != null) {
            result
                ...
                ..add(serializers.serialize(object.preprocessor,
                    specifiedType: const FullType(BroadcastActionObjectPreprocessorEnum)));
        }
    ...
    @override
    BroadcastActionObject deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = BroadcastActionObjectBuilder();
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'type':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BroadcastActionObjectTypeEnum)) as BroadcastActionObjectTypeEnum;
                    result.type = valueDes;
                    break;
                case r'sending_state':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BroadcastActionObjectSendingStateEnum)) as BroadcastActionObjectSendingStateEnum;
                ...
                case r'preprocessor':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BroadcastActionObjectPreprocessorEnum)) as BroadcastActionObjectPreprocessorEnum;
...
class BroadcastActionObjectTypeEnum extends EnumClass {

  /// The type of action.
  @BuiltValueEnumConst(wireName: r'email')
  static const BroadcastActionObjectTypeEnum email = _$broadcastActionObjectTypeEnum_email;
  /// The type of action.
  @BuiltValueEnumConst(wireName: r'twilio')
  static const BroadcastActionObjectTypeEnum twilio = _$broadcastActionObjectTypeEnum_twilio;
  /// The type of action.
  @BuiltValueEnumConst(wireName: r'urban_airship')
  static const BroadcastActionObjectTypeEnum urbanAirship = _$broadcastActionObjectTypeEnum_urbanAirship;
  /// The type of action.
  @BuiltValueEnumConst(wireName: r'slack')
  static const BroadcastActionObjectTypeEnum slack = _$broadcastActionObjectTypeEnum_slack;
  /// The type of action.
  @BuiltValueEnumConst(wireName: r'push')
  static const BroadcastActionObjectTypeEnum push = _$broadcastActionObjectTypeEnum_push;

  static Serializer<BroadcastActionObjectTypeEnum> get serializer => _$broadcastActionObjectTypeEnumSerializer;

  const BroadcastActionObjectTypeEnum._(String name): super(name);

  static BuiltSet<BroadcastActionObjectTypeEnum> get values => _$broadcastActionObjectTypeEnumValues;
  static BroadcastActionObjectTypeEnum valueOf(String name) => _$broadcastActionObjectTypeEnumValueOf(name);
}

class BroadcastActionObjectSendingStateEnum extends EnumClass {

  /// Determines the sending behavior for the action. `automatic` sends the action automatically when triggered; `draft` queues drafts when the action is triggered; or `off` to disable the action.
  @BuiltValueEnumConst(wireName: r'automatic')
  static const BroadcastActionObjectSendingStateEnum automatic = _$broadcastActionObjectSendingStateEnum_automatic;
  /// Determines the sending behavior for the action. `automatic` sends the action automatically when triggered; `draft` queues drafts when the action is triggered; or `off` to disable the action.
  @BuiltValueEnumConst(wireName: r'draft')
  static const BroadcastActionObjectSendingStateEnum draft = _$broadcastActionObjectSendingStateEnum_draft;
  /// Determines the sending behavior for the action. `automatic` sends the action automatically when triggered; `draft` queues drafts when the action is triggered; or `off` to disable the action.
  @BuiltValueEnumConst(wireName: r'off')
  static const BroadcastActionObjectSendingStateEnum off = _$broadcastActionObjectSendingStateEnum_off;

  static Serializer<BroadcastActionObjectSendingStateEnum> get serializer => _$broadcastActionObjectSendingStateEnumSerializer;

  const BroadcastActionObjectSendingStateEnum._(String name): super(name);

  static BuiltSet<BroadcastActionObjectSendingStateEnum> get values => _$broadcastActionObjectSendingStateEnumValues;
  static BroadcastActionObjectSendingStateEnum valueOf(String name) => _$broadcastActionObjectSendingStateEnumValueOf(name);
}

class BroadcastActionObjectPreprocessorEnum extends EnumClass {

  /// By default, we process CSS before emails leave Customer.io using Premailer. If your message included CSS and pre-processing is not disabled, this key indicates the pre-processor.
  @BuiltValueEnumConst(wireName: r'premailer')
  static const BroadcastActionObjectPreprocessorEnum premailer = _$broadcastActionObjectPreprocessorEnum_premailer;

  static Serializer<BroadcastActionObjectPreprocessorEnum> get serializer => _$broadcastActionObjectPreprocessorEnumSerializer;

  const BroadcastActionObjectPreprocessorEnum._(String name): super(name);

  static BuiltSet<BroadcastActionObjectPreprocessorEnum> get values => _$broadcastActionObjectPreprocessorEnumValues;
  static BroadcastActionObjectPreprocessorEnum valueOf(String name) => _$broadcastActionObjectPreprocessorEnumValueOf(name);
}
