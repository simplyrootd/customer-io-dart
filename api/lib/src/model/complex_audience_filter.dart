...
part 'complex_audience_filter.g.dart';
...
/// * [segment] 
/// * [attribute] 
abstract class ComplexAudienceFilter implements Built<ComplexAudienceFilter, ComplexAudienceFilterBuilder> {
    ...
    ComplexAudienceFilter._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(ComplexAudienceFilterBuilder b) => b;

    factory ComplexAudienceFilter([void updates(ComplexAudienceFilterBuilder b)]) = _$ComplexAudienceFilter;

    @BuiltValueSerializer(custom: true)
    static Serializer<ComplexAudienceFilter> get serializer => _$ComplexAudienceFilterSerializer();
}

class _$ComplexAudienceFilterSerializer implements StructuredSerializer<ComplexAudienceFilter> {
    @override
    final Iterable<Type> types = const [ComplexAudienceFilter, _$ComplexAudienceFilter];

    @override
    final String wireName = r'ComplexAudienceFilter';

    @override
    Iterable<Object?> serialize(Serializers serializers, ComplexAudienceFilter object,
    ...
    @override
    ComplexAudienceFilter deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = ComplexAudienceFilterBuilder();
