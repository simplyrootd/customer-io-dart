...
part 'customer_data_identifiers.g.dart';
...
abstract class CustomerDataIdentifiers implements Built<CustomerDataIdentifiers, CustomerDataIdentifiersBuilder> {
    ...
    CustomerDataIdentifiers._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(CustomerDataIdentifiersBuilder b) => b;

    factory CustomerDataIdentifiers([void updates(CustomerDataIdentifiersBuilder b)]) = _$CustomerDataIdentifiers;

    @BuiltValueSerializer(custom: true)
    static Serializer<CustomerDataIdentifiers> get serializer => _$CustomerDataIdentifiersSerializer();
}

class _$CustomerDataIdentifiersSerializer implements StructuredSerializer<CustomerDataIdentifiers> {
    @override
    final Iterable<Type> types = const [CustomerDataIdentifiers, _$CustomerDataIdentifiers];

    @override
    final String wireName = r'CustomerDataIdentifiers';

    @override
    Iterable<Object?> serialize(Serializers serializers, CustomerDataIdentifiers object,
    ...
    @override
    CustomerDataIdentifiers deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = CustomerDataIdentifiersBuilder();
