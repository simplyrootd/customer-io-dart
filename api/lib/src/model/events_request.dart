...
import 'package:customer_io_gen/src/model/standard_event.dart';
import 'package:built_collection/built_collection.dart';
import 'package:customer_io_gen/src/model/mobile_screen_view1.dart';
import 'package:customer_io_gen/src/model/page_view1.dart';
...
abstract class EventsRequest implements Built<EventsRequest, EventsRequestBuilder> {
    ...
    EventsRequestTypeEnum get type;
    ...
    static void _defaults(EventsRequestBuilder b) => b;

    factory EventsRequest([void updates(EventsRequestBuilder b)]) = _$EventsRequest;

    @BuiltValueSerializer(custom: true)
    static Serializer<EventsRequest> get serializer => _$EventsRequestSerializer();
}

class _$EventsRequestSerializer implements StructuredSerializer<EventsRequest> {
    @override
    final Iterable<Type> types = const [EventsRequest, _$EventsRequest];

    @override
    final String wireName = r'EventsRequest';

    @override
    Iterable<Object?> serialize(Serializers serializers, EventsRequest object,
        ...
        result
            ...
            ..add(serializers.serialize(object.type,
                specifiedType: const FullType(EventsRequestTypeEnum)));
    ...
    @override
    EventsRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'type':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(EventsRequestTypeEnum)) as EventsRequestTypeEnum;
...
class EventsRequestTypeEnum extends EnumClass {

  /// Indicates that the event represents a mobile screen view. You can also capture screen events directly with [our iOS SDK](/docs/sdk/ios/track-events/#screen-view-events).
  @BuiltValueEnumConst(wireName: r'screen')
  static const EventsRequestTypeEnum screen = _$eventsRequestTypeEnum_screen;

  static Serializer<EventsRequestTypeEnum> get serializer => _$eventsRequestTypeEnumSerializer;

  const EventsRequestTypeEnum._(String name): super(name);

  static BuiltSet<EventsRequestTypeEnum> get values => _$eventsRequestTypeEnumValues;
  static EventsRequestTypeEnum valueOf(String name) => _$eventsRequestTypeEnumValueOf(name);
}
