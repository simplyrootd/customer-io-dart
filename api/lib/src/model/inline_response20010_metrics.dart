...
part 'inline_response20010_metrics.g.dart';
...
abstract class InlineResponse20010Metrics implements Built<InlineResponse20010Metrics, InlineResponse20010MetricsBuilder> {
    ...
    InlineResponse20010Metrics._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(InlineResponse20010MetricsBuilder b) => b;

    factory InlineResponse20010Metrics([void updates(InlineResponse20010MetricsBuilder b)]) = _$InlineResponse20010Metrics;

    @BuiltValueSerializer(custom: true)
    static Serializer<InlineResponse20010Metrics> get serializer => _$InlineResponse20010MetricsSerializer();
}

class _$InlineResponse20010MetricsSerializer implements StructuredSerializer<InlineResponse20010Metrics> {
    @override
    final Iterable<Type> types = const [InlineResponse20010Metrics, _$InlineResponse20010Metrics];

    @override
    final String wireName = r'InlineResponse20010Metrics';

    @override
    Iterable<Object?> serialize(Serializers serializers, InlineResponse20010Metrics object,
    ...
    @override
    InlineResponse20010Metrics deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = InlineResponse20010MetricsBuilder();
