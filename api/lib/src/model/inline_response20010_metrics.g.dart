...
part of 'inline_response20010_metrics.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$InlineResponse20010Metrics extends InlineResponse20010Metrics {
  @override
  final int? bounced;
  @override
  final int? clicked;
  ...
  factory _$InlineResponse20010Metrics(
          [void Function(InlineResponse20010MetricsBuilder)? updates]) =>
      (new InlineResponse20010MetricsBuilder()..update(updates)).build();

  _$InlineResponse20010Metrics._(
      {this.bounced,
      this.clicked,
      this.converted,
      this.created,
  ...
  @override
  InlineResponse20010Metrics rebuild(
          void Function(InlineResponse20010MetricsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  InlineResponse20010MetricsBuilder toBuilder() =>
      new InlineResponse20010MetricsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is InlineResponse20010Metrics &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('InlineResponse20010Metrics')
          ..add('bounced', bounced)
          ..add('clicked', clicked)
...
class InlineResponse20010MetricsBuilder
    implements
        Builder<InlineResponse20010Metrics, InlineResponse20010MetricsBuilder> {
  _$InlineResponse20010Metrics? _$v;
  ...
  InlineResponse20010MetricsBuilder() {
    InlineResponse20010Metrics._defaults(this);
  }

  InlineResponse20010MetricsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _bounced = $v.bounced;
      _clicked = $v.clicked;
  ...
  @override
  void replace(InlineResponse20010Metrics other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$InlineResponse20010Metrics;
  }

  @override
  void update(void Function(InlineResponse20010MetricsBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$InlineResponse20010Metrics build() {
    final _$result = _$v ??
        new _$InlineResponse20010Metrics._(
            bounced: bounced,
            clicked: clicked,
            converted: converted,
            created: created,
