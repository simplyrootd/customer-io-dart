...
///
/// Properties:
/// * [errors] - A list of errors in the format `line undefined<x>: undefined<error text>` to help you troubleshoot errors associated with your audience or data file.
/// * [next] - Indicates the next page of results. Add `?start=undefined<next_value>` to the request to get the next page of results.
abstract class InlineResponse2002 implements Built<InlineResponse2002, InlineResponse2002Builder> {
    /// A list of errors in the format `line undefined<x>: undefined<error text>` to help you troubleshoot errors associated with your audience or data file.
    @BuiltValueField(wireName: r'errors')
    BuiltList<String>? get errors;

    /// Indicates the next page of results. Add `?start=undefined<next_value>` to the request to get the next page of results.
