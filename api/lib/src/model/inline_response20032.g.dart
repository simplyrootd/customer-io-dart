...
class _$InlineResponse20032 extends InlineResponse20032 {
  ...
  _$InlineResponse20032._({this.url}) : super._();
  ...
  bool operator ==(Object other) {
    ...
    return other is InlineResponse20032 && url == other.url;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('InlineResponse20032')..add('url', url))
        .toString();
  }
}
...
class InlineResponse20032Builder
  ...
  InlineResponse20032Builder() {
    InlineResponse20032._defaults(this);
  }
  ...
  _$InlineResponse20032 build() {
    final _$result = _$v ?? new _$InlineResponse20032._(url: url);
    replace(_$result);
    return _$result;
  }
}
