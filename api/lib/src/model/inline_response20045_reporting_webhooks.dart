...
part 'inline_response20045_reporting_webhooks.g.dart';

/// InlineResponse20045ReportingWebhooks
///
/// Properties:
...
abstract class InlineResponse20045ReportingWebhooks implements Built<InlineResponse20045ReportingWebhooks, InlineResponse20045ReportingWebhooksBuilder> {
    ...
    InlineResponse20045ReportingWebhooks._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(InlineResponse20045ReportingWebhooksBuilder b) => b
        ..fullResolution = false;

    factory InlineResponse20045ReportingWebhooks([void updates(InlineResponse20045ReportingWebhooksBuilder b)]) = _$InlineResponse20045ReportingWebhooks;

    @BuiltValueSerializer(custom: true)
    static Serializer<InlineResponse20045ReportingWebhooks> get serializer => _$InlineResponse20045ReportingWebhooksSerializer();
}

class _$InlineResponse20045ReportingWebhooksSerializer implements StructuredSerializer<InlineResponse20045ReportingWebhooks> {
    @override
    final Iterable<Type> types = const [InlineResponse20045ReportingWebhooks, _$InlineResponse20045ReportingWebhooks];

    @override
    final String wireName = r'InlineResponse20045ReportingWebhooks';

    @override
    Iterable<Object?> serialize(Serializers serializers, InlineResponse20045ReportingWebhooks object,
    ...
    @override
    InlineResponse20045ReportingWebhooks deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = InlineResponse20045ReportingWebhooksBuilder();
