...
part 'inline_response20055_messages.g.dart';
...
abstract class InlineResponse20055Messages implements Built<InlineResponse20055Messages, InlineResponse20055MessagesBuilder> {
    ...
    InlineResponse20055Messages._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(InlineResponse20055MessagesBuilder b) => b;

    factory InlineResponse20055Messages([void updates(InlineResponse20055MessagesBuilder b)]) = _$InlineResponse20055Messages;

    @BuiltValueSerializer(custom: true)
    static Serializer<InlineResponse20055Messages> get serializer => _$InlineResponse20055MessagesSerializer();
}

class _$InlineResponse20055MessagesSerializer implements StructuredSerializer<InlineResponse20055Messages> {
    @override
    final Iterable<Type> types = const [InlineResponse20055Messages, _$InlineResponse20055Messages];

    @override
    final String wireName = r'InlineResponse20055Messages';

    @override
    Iterable<Object?> serialize(Serializers serializers, InlineResponse20055Messages object,
    ...
    @override
    InlineResponse20055Messages deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = InlineResponse20055MessagesBuilder();
