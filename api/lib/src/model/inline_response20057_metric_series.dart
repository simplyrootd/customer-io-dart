...
part 'inline_response20057_metric_series.g.dart';
...
abstract class InlineResponse20057MetricSeries implements Built<InlineResponse20057MetricSeries, InlineResponse20057MetricSeriesBuilder> {
    ...
    InlineResponse20057MetricSeries._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(InlineResponse20057MetricSeriesBuilder b) => b;

    factory InlineResponse20057MetricSeries([void updates(InlineResponse20057MetricSeriesBuilder b)]) = _$InlineResponse20057MetricSeries;

    @BuiltValueSerializer(custom: true)
    static Serializer<InlineResponse20057MetricSeries> get serializer => _$InlineResponse20057MetricSeriesSerializer();
}

class _$InlineResponse20057MetricSeriesSerializer implements StructuredSerializer<InlineResponse20057MetricSeries> {
    @override
    final Iterable<Type> types = const [InlineResponse20057MetricSeries, _$InlineResponse20057MetricSeries];

    @override
    final String wireName = r'InlineResponse20057MetricSeries';

    @override
    Iterable<Object?> serialize(Serializers serializers, InlineResponse20057MetricSeries object,
    ...
    @override
    InlineResponse20057MetricSeries deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = InlineResponse20057MetricSeriesBuilder();
