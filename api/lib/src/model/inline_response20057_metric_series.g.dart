...
part of 'inline_response20057_metric_series.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$InlineResponse20057MetricSeries
    extends InlineResponse20057MetricSeries {
  @override
  ...
  factory _$InlineResponse20057MetricSeries(
          [void Function(InlineResponse20057MetricSeriesBuilder)? updates]) =>
      (new InlineResponse20057MetricSeriesBuilder()..update(updates)).build();

  _$InlineResponse20057MetricSeries._(
      {this.attempted,
      this.bounced,
      this.clicked,
      this.converted,
  ...
  @override
  InlineResponse20057MetricSeries rebuild(
          void Function(InlineResponse20057MetricSeriesBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  InlineResponse20057MetricSeriesBuilder toBuilder() =>
      new InlineResponse20057MetricSeriesBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is InlineResponse20057MetricSeries &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('InlineResponse20057MetricSeries')
...
class InlineResponse20057MetricSeriesBuilder
    implements
        Builder<InlineResponse20057MetricSeries,
            InlineResponse20057MetricSeriesBuilder> {
  _$InlineResponse20057MetricSeries? _$v;
  ...
  InlineResponse20057MetricSeriesBuilder() {
    InlineResponse20057MetricSeries._defaults(this);
  }

  InlineResponse20057MetricSeriesBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(InlineResponse20057MetricSeries other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$InlineResponse20057MetricSeries;
  }

  @override
  void update(void Function(InlineResponse20057MetricSeriesBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$InlineResponse20057MetricSeries build() {
    _$InlineResponse20057MetricSeries _$result;
    try {
      _$result = _$v ??
          new _$InlineResponse20057MetricSeries._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'InlineResponse20057MetricSeries', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
