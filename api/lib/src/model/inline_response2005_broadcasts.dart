...
part 'inline_response2005_broadcasts.g.dart';

/// InlineResponse2005Broadcasts
///
/// Properties:
...
abstract class InlineResponse2005Broadcasts implements Built<InlineResponse2005Broadcasts, InlineResponse2005BroadcastsBuilder> {
    ...
    InlineResponse2005Broadcasts._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(InlineResponse2005BroadcastsBuilder b) => b;

    factory InlineResponse2005Broadcasts([void updates(InlineResponse2005BroadcastsBuilder b)]) = _$InlineResponse2005Broadcasts;

    @BuiltValueSerializer(custom: true)
    static Serializer<InlineResponse2005Broadcasts> get serializer => _$InlineResponse2005BroadcastsSerializer();
}

class _$InlineResponse2005BroadcastsSerializer implements StructuredSerializer<InlineResponse2005Broadcasts> {
    @override
    final Iterable<Type> types = const [InlineResponse2005Broadcasts, _$InlineResponse2005Broadcasts];

    @override
    final String wireName = r'InlineResponse2005Broadcasts';

    @override
    Iterable<Object?> serialize(Serializers serializers, InlineResponse2005Broadcasts object,
    ...
    @override
    InlineResponse2005Broadcasts deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = InlineResponse2005BroadcastsBuilder();
