...
part of 'message_total_metrics.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$MessageTotalMetrics extends MessageTotalMetrics {
  @override
  final int? bounced;
  @override
  final int? clicked;
  ...
  factory _$MessageTotalMetrics(
          [void Function(MessageTotalMetricsBuilder)? updates]) =>
      (new MessageTotalMetricsBuilder()..update(updates)).build();

  _$MessageTotalMetrics._(
      {this.bounced,
      this.clicked,
      this.converted,
      this.created,
  ...
  @override
  MessageTotalMetrics rebuild(
          void Function(MessageTotalMetricsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  MessageTotalMetricsBuilder toBuilder() =>
      new MessageTotalMetricsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is MessageTotalMetrics &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('MessageTotalMetrics')
          ..add('bounced', bounced)
          ..add('clicked', clicked)
...
class MessageTotalMetricsBuilder
    implements Builder<MessageTotalMetrics, MessageTotalMetricsBuilder> {
  _$MessageTotalMetrics? _$v;
  ...
  MessageTotalMetricsBuilder() {
    MessageTotalMetrics._defaults(this);
  }

  MessageTotalMetricsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _bounced = $v.bounced;
      _clicked = $v.clicked;
  ...
  @override
  void replace(MessageTotalMetrics other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$MessageTotalMetrics;
  }

  @override
  void update(void Function(MessageTotalMetricsBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$MessageTotalMetrics build() {
    final _$result = _$v ??
        new _$MessageTotalMetrics._(
            bounced: bounced,
            clicked: clicked,
            converted: converted,
            created: created,
