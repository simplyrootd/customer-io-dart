...
abstract class NewsletterObject implements Built<NewsletterObject, NewsletterObjectBuilder> {
    ...
    static void _defaults(NewsletterObjectBuilder b) => b;

    factory NewsletterObject([void updates(NewsletterObjectBuilder b)]) = _$NewsletterObject;

    @BuiltValueSerializer(custom: true)
    static Serializer<NewsletterObject> get serializer => _$NewsletterObjectSerializer();
}

class _$NewsletterObjectSerializer implements StructuredSerializer<NewsletterObject> {
    @override
    final Iterable<Type> types = const [NewsletterObject, _$NewsletterObject];

    @override
    final String wireName = r'NewsletterObject';

    @override
    Iterable<Object?> serialize(Serializers serializers, NewsletterObject object,
    ...
    @override
    NewsletterObject deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = NewsletterObjectBuilder();
