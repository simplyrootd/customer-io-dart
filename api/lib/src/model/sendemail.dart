...
part 'sendemail.g.dart';

/// The payload of a transactional message.
///
/// Properties:
/// * [transactionalMessageId] - The transactional message that you want to send. When you set up a transactional message in Customer.io, it functions as a template that you call by ID.
/// * [body] - The body of your message. This overrides the body of the transactional template (referenced by `transactional_message_id`).
/// * [subject] - The subject line for your message. This overrides the subject of the transactional template (referenced by `transactional_message_id`).
...
abstract class Sendemail implements Built<Sendemail, SendemailBuilder> {
    ...
    @BuiltValueField(wireName: r'transactional_message_id')
    int get transactionalMessageId;
    ...
    static void _defaults(SendemailBuilder b) => b
    ...
    factory Sendemail([void updates(SendemailBuilder b)]) = _$Sendemail;

    @BuiltValueSerializer(custom: true)
    static Serializer<Sendemail> get serializer => _$SendemailSerializer();
}

class _$SendemailSerializer implements StructuredSerializer<Sendemail> {
    @override
    final Iterable<Type> types = const [Sendemail, _$Sendemail];

    @override
    final String wireName = r'Sendemail';

    @override
    Iterable<Object?> serialize(Serializers serializers, Sendemail object,
        {FullType specifiedType = FullType.unspecified}) {
        final result = <Object?>[];
        result
            ..add(r'transactional_message_id')
            ..add(serializers.serialize(object.transactionalMessageId,
    ...
    @override
    Sendemail deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = SendemailBuilder();
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                case r'transactional_message_id':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(int)) as int;
                    result.transactionalMessageId = valueDes;
                    break;
                case r'body':
                    final valueDes = serializers.deserialize(value,
