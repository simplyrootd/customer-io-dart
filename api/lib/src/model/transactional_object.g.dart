...
part of 'transactional_object.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$TransactionalObject extends TransactionalObject {
  @override
  final int? id;
  @override
  final String? name;
  ...
  factory _$TransactionalObject(
          [void Function(TransactionalObjectBuilder)? updates]) =>
      (new TransactionalObjectBuilder()..update(updates)).build();

  _$TransactionalObject._(
      {this.id,
      this.name,
      this.description,
  ...
  @override
  TransactionalObject rebuild(
          void Function(TransactionalObjectBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  TransactionalObjectBuilder toBuilder() =>
      new TransactionalObjectBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is TransactionalObject &&
        id == other.id &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('TransactionalObject')
          ..add('id', id)
          ..add('name', name)
...
class TransactionalObjectBuilder
    implements Builder<TransactionalObject, TransactionalObjectBuilder> {
  _$TransactionalObject? _$v;
  ...
  TransactionalObjectBuilder() {
    TransactionalObject._defaults(this);
  }

  TransactionalObjectBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
      _name = $v.name;
  ...
  @override
  void replace(TransactionalObject other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$TransactionalObject;
  }

  @override
  void update(void Function(TransactionalObjectBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$TransactionalObject build() {
    final _$result = _$v ??
        new _$TransactionalObject._(
            id: id,
            name: name,
